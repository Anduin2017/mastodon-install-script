...
git clone https://git.aiursoft.com/PublicVault/mastodon.git ~/live
...
then
  ...
  git clone https://git.aiursoft.com/PublicVault/rbenv.git ~/.rbenv
  cd ~/.rbenv && src/configure && make -C src
  echo 'export PATH="$HOME/.rbenv/bin:$PATH"' >> ~/.bashrc
  echo 'eval "$(rbenv init -)"' >> ~/.bashrc
  export  PATH=$HOME/.rbenv/bin:$PATH
  eval "$(rbenv init -)"
  git clone https://git.aiursoft.com/PublicVault/ruby-build.git ~/.rbenv/plugins/ruby-build
  cd -
fi
